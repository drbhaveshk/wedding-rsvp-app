      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 mb-6 text-center">
          <div className="mb-6">
            ...
            <h1 className="text-4xl font-bold text-gray-800 mb-2">You are Invited!</h1>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                {isGuestsRequired ? 'Required if attending' : 'Not required if you are not attending'}
              </p>
            </div>
              ...
              <div className="space-y-3">
                <label className="flex items-center cursor-pointer p-3 border-2 border-gray-200 rounded-lg hover:border-pink-300 transition-colors">
                  <input
                    ...
                    required
                  />
                  <span className="text-gray-700 font-medium">Yes, I will be there!</span>
                </label>
                ...
                <label className="flex items-center cursor-pointer p-3 border-2 border-gray-200 rounded-lg hover:border-red-300 transition-colors">
                  <input
                    ...
                    className="mr-3"
                  />
                  <span className="text-gray-700 font-medium">Sorry, cannot make it</span>
                </label>
              </div>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                {isAadharRequired ? 'Required if attending. You can upload multiple files.' : 'Not required if you are not attending. You can upload multiple files.'}
              </p>
            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                ...
                {formData.attending === 'no' 
                  ? ' Since you are not attending, only your name and attendance status are required.'
                  : isGuestsRequired 
